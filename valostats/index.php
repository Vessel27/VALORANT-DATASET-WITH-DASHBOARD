...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" id="sidebar">
                        <li class="nav-item">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        <canvas id="myDonutChart" height="500px"></canvas>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Top 10 Lowest Prices</h3>
                            </div>
                            <div class="card-body">
                                <ul id="lowestPrices" class="list-group"></ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Top 10 Highest Prices</h3>
                            </div>
                            <div class="card-body">
                                <ul id="highestPrices" class="list-group"></ul>
                            </div>
                        </div>
                    </div>
                </div>
