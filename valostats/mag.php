                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Top 10 Lowest Magazine Capacity</h3>
                            </div>
                            <div class="card-body">
                                <ul id="lowestMag" class="list-group"></ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Top 10 Highest Magazine Capacity</h3>
                            </div>
                            <div class="card-body">
                                <ul id="highestMag" class="list-group"></ul>
                            </div>
                        </div>
                    </div>
                </div>
