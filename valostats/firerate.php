        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        <canvas id="myPolarChart" height="500px"></canvas>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Top 10 Lowest Firerate Weapons</h3>
                            </div>
                            <div class="card-body">
                                <ul id="lowestRates" class="list-group"></ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Top 10 Highest Fireate Weapons</h3>
                            </div>
                            <div class="card-body">
                                <ul id="highestRates" class="list-group"></ul>
                            </div>
                        </div>
                    </div>
                </div>
